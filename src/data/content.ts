...
export const serviceProviders = [
  {
    ...
    providers: [
      ...
      },
      {
        ...
        url: "http://Diffusiontekfinishing.com",
        website: "Diffusiontekfinishing.com",
        phone: "(616) 212-2108",
      },
    ],
  },
  {
    ...
    providers: [
      {
        company: "Hubbell Power Systems",
        location: "Centralia, Missouri",
        url: "http://Hubbell.com",
        website: "Hubbell.com",
        phone: "(573) 682-5521",
      },
      {
...
export const navigation: NavItem[] = [
  ...
  { id: "join-team", label: "Join the Team", href: "#footer" },
];
