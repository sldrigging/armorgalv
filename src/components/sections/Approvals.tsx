                  ...
                  >
                    <div className="grid grid-cols-2 gap-x-8 gap-y-6 md:gap-y-12 items-center justify-items-center w-full">
                      {Array.from({ length: 8 }).map((_, i) => {
                        ...
                        const imgPath = (images as Record<string, string>)[imgKey];
                        return (
                          <div
                            key={imgKey}
              ...
              <div className="order-1 md:order-1 flex flex-col justify-center">
                <div className="w-full max-w-xl flex flex-col items-start text-left mx-auto">
                  <motion.h3
                    ...
                    transition={{ duration: 0.8 }}
                  >
                    STANDARDS &<br />GOVERNMENT AGENCIES
                  </motion.h3>
                  ...
                  >
                    <p>Meets ASTM A-123, ASTM A-153, ASTM A-1059 standards.</p>
                    <p>Compliant with U2S NACE TM0177 specification for oil well applications.</p>
